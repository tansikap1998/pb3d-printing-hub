...
export const translations = {
  TH: {
    ...
    hero: {
      subtitle: "The Future of Production — From Digital to Physical",
      title1: "Digital",
      ...
      online: "Ships within 48 hrs",
      cta: "Start Your Project →",
      ctaSearch: "No File? Search Models",
      copyTag: "If you can imagine it, we can print it.",
    },
    howItWorks: {
    ...
    materials: {
      ...
      items: {
        ...
        ABS: {
          details: "วัสดุทนความร้อนสูง แข็งแรงและ���หนียว ผิวสัมผัสด้านเรียบเนียน สามารถขัดแต่งผิวได้ง่ายเหมือนชิ้นส่วนพลาสติกในรถยนต์",
