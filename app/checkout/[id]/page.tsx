    ...
    <div className="min-h-screen bg-[#000000] text-[#F2F2F2] font-sans selection:bg-white/20 pb-32">
      ...
      <main className="max-w-6xl mx-auto px-6 pt-16">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
          <Link href="/upload" className="flex items-center gap-2 text-white/40 hover:text-white transition-colors text-sm font-header uppercase tracking-widest">
          ...
          <div className="space-y-8">
            <div className="bg-white/5 border border-white/10 rounded-[2.5rem] p-10 text-center flex flex-col items-center shadow-2xl">
              ...
              <div className="flex flex-col gap-2">
                <p className="font-header text-[10px] tracking-widest uppercase opacity-40">Scan to pay instantly</p>
                <button className="flex items-center gap-2 text-white/60 hover:text-white transition-colors text-[10px] font-header uppercase tracking-widest mt-2">
          ...
          <div className="bg-white/[0.02] border border-white/10 rounded-[2.5rem] p-10 flex flex-col shadow-2xl">
              ...
              {slipPreview ? (
                <div className="absolute inset-0 bg-neutral-900">
                  ...
                  <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-4 z-30">
                    <button className="font-header text-[10px] tracking-widest uppercase bg-white text-black px-4 py-2 rounded-xl">Replace</button>
                    <button onClick={(e) => { e.preventDefault(); setSlipFile(null); setSlipPreview(null); }} className="font-header text-[10px] tracking-widest uppercase bg-red-500 text-white px-4 py-2 rounded-xl">Delete</button>
                  </div>
            ...
            <div className="mt-auto pt-8">
              ...
              <button 
                ...
                className={`w-full py-6 rounded-2xl font-header text-sm uppercase tracking-[0.4em] transition-all duration-300 shadow-2xl flex items-center justify-center gap-3 ${
