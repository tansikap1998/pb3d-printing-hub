  ...
  return (
    <div className="min-h-screen bg-[#080810] text-white flex items-center justify-center p-6">
      <div className="w-full max-w-sm space-y-6">
        ...
        {/* Login Card */}
        <div className="bg-white/[0.03] border border-white/10 rounded-3xl p-7 shadow-2xl">
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              ...
              className="w-full py-4 bg-white text-black font-header text-base uppercase tracking-[0.15em] rounded-2xl hover:bg-gray-100 transition-all disabled:opacity-30 flex items-center justify-center gap-3 shadow-lg active:scale-[0.98] mt-2"
            >
              {loading
